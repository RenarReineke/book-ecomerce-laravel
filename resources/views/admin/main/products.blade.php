...
<div class="m-3 p-10 h-auto bg-sky-50">
    <table
        class="mx-auto w-full table-auto border-collapse border border-slate-400 bg-white text-md"
    >
        <thead class="bg-slate-400">
            <tr class="h-10">
                <th class="p-2 border border-slate-300">Del</th>
                <th class="p-2 border border-slate-300">Pic</th>
                ...
                <th class="p-2 border border-slate-300">Edit</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="h-10 hover:bg-slate-200 hover:cursor-pointer">
                ...
                <td class="p-2 text-center border border-slate-300">
                    {{$product->series->publisher->title}}
                </td>
                <td class="p-2 text-center border border-slate-300">
                    {{$product->year}}
                </td>
