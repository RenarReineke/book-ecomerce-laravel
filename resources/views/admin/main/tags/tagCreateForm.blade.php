...
<div class="max-w-md mx-auto">
    ...
    <h2 class="mt-1 text-2xl sm:text-xl font-bold text-slate-500">Создать тег</h1>
</div>
...
<div class="p-6 sm:p-10 sm:pt-0 mx-auto max-w-md w-full bg-white/80 backdrop-blur-xl rounded-xl shadow-xl">
    <form action="{{route('tags.store')}}" method="post" novalidate class="space-y-6">
        @csrf
