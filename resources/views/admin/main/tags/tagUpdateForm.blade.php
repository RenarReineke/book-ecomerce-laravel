...
<div class="max-w-md mx-auto">
    ...
    <h2 class="mt-1 text-2xl sm:text-xl font-bold text-slate-500">Редактировать тег</h1>
</div>
...
<div class="p-6 sm:p-10 sm:pt-0 mx-auto max-w-md w-full bg-white/80 backdrop-blur-xl rounded-xl shadow-xl">
    <form action="{{route('tags.update', ['tag' => $tag])}}" method="post" novalidate class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div class="relative rounded-md shadow-sm mt-1">
                ...
                <input value="{{old('title')}}" type="text" id="title" name="title" required placeholder="Новинки" class="pl-10 w-full rounded-md text-sm {{ $errors->has('title') ? 'placeholder-red-300 border-red-300 focus:border-red-500 focus:ring-red-500' : 'placeholder:text-gray-400 border-gray-300 focus:border-cyan-500 focus:ring-cyan-500'}}">
                @error('title')
