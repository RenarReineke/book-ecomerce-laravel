...
<!-- Общий светлый фон со скругленными углами -->
<div class="">
    <!-- Main -->
    <div class="p-10 pt-4 px-5 h-auto w-full bg-sky-50">
        ...
        >
            Отзыв <span class="mx-1 font-bold">№ {{$rewiew->id}} </span> клиента
            <span class="mx-1 font-bold capitalize">{{$rewiew->user->name}}</span> на товар
